...
{#if $page.state.showModal === 'settings'}
  <Modal title="Settings" on:close={() => history.back()}>
    <div class="flex rounded-md items-center w-full py-2 my-2 gap-3 text-sm text-gray-900 dark:text-white">
    ...
    <button
      ...
      class="flex rounded-md items-center w-full py-2 my-2 gap-3 text-sm hover:bg-primary text-gray-900 hover:text-white dark:text-white"
    >
