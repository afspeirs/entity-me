...
export const themeSystem = derived([themeUser, themeMedia], ([$themeUser, $themeMedia]) => {
  // Prioritize user-selected theme over system theme
...
mql.addEventListener('change', () => {
  themeUser.set('default'); // This is a temporary thing until I update the UI to allow the user to select this manually
