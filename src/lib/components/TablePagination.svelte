  ...
  >
    ...
    <div class="flex flex-1 justify-between sm:justify-end">
      <button
        ...
        class="relative ml-3 inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold not-disabled:cursor-pointer enabled:hover:bg-black/5 dark:enabled:hover:bg-white/5 text-dark dark:text-white disabled:opacity-40 focus-outline"
      >
        Previous
      </button>
      <button
